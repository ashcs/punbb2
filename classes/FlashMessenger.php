...
class FlashMessenger
{
	...
	public function __construct()
	{
		...
		if (!$disabled)
		{
			ForumFunction::forum_session_start();
		}
	...
	public function show($just_return = false)
	{
		...
		$message = sprintf(self::TEMPLATE_MSG, ForumFunction::forum_htmlencode($this->message[1]), ForumFunction::forum_htmlencode($this->message[0]));
