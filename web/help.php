...
($hook = ForumFunction::get_hook('he_main_output_start')) ? eval($hook) : null;
...
<?php ($hook = ForumFunction::get_hook('he_new_bbcode_text_style')) ? eval($hook) : null; ?>
		</div>
		<div class="ct-box help-box">
			<h3 class="hn"><span><?php echo $lang_help['Links info'] ?></span></h3>
			<div class="entry-content">
				<code>[url=<?php echo $base_url.'/' ?>]<?php echo ForumFunction::forum_htmlencode($forum_config['o_board_title']) ?>[/url]</code> <span><?php echo $lang_help['produces'] ?></span>
				<samp><a href="<?php echo $base_url.'/' ?>"><?php echo ForumFunction::forum_htmlencode($forum_config['o_board_title']) ?></a></samp>
			</div>
			<div class="entry-content">
...
<?php ($hook = ForumFunction::get_hook('he_new_bbcode_link')) ? eval($hook) : null; ?>
		</div>
		<div class="ct-box help-box">
...
<?php ($hook = ForumFunction::get_hook('he_new_bbcode_section')) ? eval($hook) : null; ?>
	</div>
<?php
...
?>
	...
	<div class="main-content main-frm">
		...
		<?php ($hook = ForumFunction::get_hook('he_new_img_section')) ? eval($hook) : null; ?>
	</div>
<?php
...
<?php
	...
	($hook = ForumFunction::get_hook('he_pre_smile_display')) ? eval($hook) : null;
...
($hook = ForumFunction::get_hook('he_new_section')) ? eval($hook) : null;
...
($hook = ForumFunction::get_hook('he_end')) ? eval($hook) : null;
