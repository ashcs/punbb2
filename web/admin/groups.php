...
($hook = ForumFunction::get_hook('agr_start')) ? eval($hook) : null;
...
if (isset($_POST['add_group']) || isset($_GET['edit_group']))
{
	...
	{
		($hook = ForumFunction::get_hook('agr_add_group_form_submitted')) ? eval($hook) : null;
		...
		($hook = ForumFunction::get_hook('agr_add_group_qr_get_base_group')) ? eval($hook) : null;
	...
	{
		($hook = ForumFunction::get_hook('agr_edit_group_form_submitted')) ? eval($hook) : null;
		...
		($hook = ForumFunction::get_hook('agr_edit_group_qr_get_group')) ? eval($hook) : null;
		$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		$group = $forum_db->fetch_assoc($result);
	...
	$forum_page['crumbs'] = array(
		...
		array($lang_admin_common['Groups'], ForumFunction::forum_link($forum_url['admin_groups'])),
		$mode == 'edit' ? $lang_admin_groups['Edit group heading'] : $lang_admin_groups['Add group heading']
	);

	($hook = ForumFunction::get_hook('agr_add_edit_group_pre_header_load')) ? eval($hook) : null;
	...
	($hook = ForumFunction::get_hook('agr_add_edit_group_output_start')) ? eval($hook) : null;
...
?>
	...
	<div class="main-content main-frm">
		...
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo ForumFunction::forum_link($forum_url['admin_groups']) ?>">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo ForumFunction::generate_form_token(ForumFunction::forum_link($forum_url['admin_groups'])) ?>" />
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_basic_details_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Group title legend'] ?></span></legend>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_group_title')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text required">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="req_title" size="25" maxlength="50" value="<?php if ($mode == 'edit') echo ForumFunction::forum_htmlencode($group['g_title']); ?>" required /></span>
					</div>
				</div>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_user_title')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text required">
						...
						<span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="user_title" size="25" maxlength="50" value="<?php echo ForumFunction::forum_htmlencode($group['g_user_title']) ?>" /></span>
					</div>
				</div>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_basic_details_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php

	($hook = ForumFunction::get_hook('agr_add_edit_group_basic_details_fieldset_end')) ? eval($hook) : null;
...
<?php endif; ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_permissions_fieldset')) ? eval($hook) : null; ?>
				<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
					<legend class="group-legend"><strong><?php echo $lang_admin_groups['Permissions'] ?></strong></legend>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_mod_permissions_fieldset')) ? eval($hook) : null; if ($group['g_id'] != FORUM_GUEST): if ($mode != 'edit' || $forum_config['o_default_user_group'] != $group['g_id']): ?>
					<fieldset class="mf-set set<?php echo ++$forum_page['item_count'] ?>">
						<legend><span><?php echo $lang_admin_groups['Mod permissions'] ?></span></legend>
						<div class="mf-box">
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_moderate_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_mod_edit_profiles_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_mod_edit_userbane_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_mod_change_pass_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_mod_ban_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_mod_permissions_fieldset_end')) ? eval($hook) : null; ?>
						</div>
					</fieldset>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_mod_permissions_fieldset_end')) ? eval($hook) : null; endif; endif; ?>
					<fieldset class="mf-set set<?php echo ++$forum_page['item_count'] ?>">
						<legend><span><?php echo $lang_admin_groups['User permissions'] ?></span></legend>
						<div class="mf-box">
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_read_board_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_view_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_post_replies_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_post_topics_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_edit_posts_checkbox')) ? eval($hook) : null; if ($group['g_id'] != FORUM_GUEST): ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_delete_posts_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_delete_topics_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_set_user_title_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php endif; ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_search_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_search_users_checkbox')) ? eval($hook) : null; ?>
							<div class="mf-item">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_allow_send_email_checkbox')) ? eval($hook) : null; if ($group['g_id'] != FORUM_GUEST): ?>
							<div class="mf-item">
...
<?php endif; ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_user_permissions_fieldset_end')) ? eval($hook) : null; ?>
						</div>
					</fieldset>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_user_permissions_fieldset_end')) ? eval($hook) : null; ?>
				</fieldset>
<?php
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_flood_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Restrictions'] ?></span></legend>
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_post_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
...
<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_search_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
...
<?php
		...
		($hook = ForumFunction::get_hook('agr_add_edit_group_pre_email_interval')) ? eval($hook) : null;
...
?>
				<?php ($hook = ForumFunction::get_hook('agr_add_edit_group_pre_email_interval')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
...
<?php
		...
		($hook = ForumFunction::get_hook('agr_add_edit_group_pre_flood_fieldset_end')) ? eval($hook) : null;

?>
			</fieldset>
<?php

		($hook = ForumFunction::get_hook('agr_add_edit_group_flood_fieldset_end')) ? eval($hook) : null;
	}
...
<?php
	...
	($hook = ForumFunction::get_hook('agr_add_edit_group_end')) ? eval($hook) : null;
...
else if (isset($_POST['add_edit_group']))
{
	...
	$title = ForumFunction::forum_trim($_POST['req_title']);
	$user_title = ForumFunction::forum_trim($_POST['user_title']);
	...
	if ($title == '')
		ForumFunction::message($lang_admin_groups['Must enter group message']);

	$user_title = ($user_title != '') ? '\''.$forum_db->escape($user_title).'\'' : 'NULL';

	($hook = ForumFunction::get_hook('agr_add_edit_end_validation')) ? eval($hook) : null;


	if ($_POST['mode'] == 'add')
	{
		($hook = ForumFunction::get_hook('agr_add_add_group')) ? eval($hook) : null;
		...
		($hook = ForumFunction::get_hook('agr_add_end_qr_check_add_group_title_collision')) ? eval($hook) : null;
		$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);

		if ($forum_db->result($result) != 0)
			ForumFunction::message(sprintf($lang_admin_groups['Already a group message'], ForumFunction::forum_htmlencode($title)));
		...
		($hook = ForumFunction::get_hook('agr_add_end_qr_add_group')) ? eval($hook) : null;
		...
		($hook = ForumFunction::get_hook('agr_add_end_qr_get_group_forum_perms')) ? eval($hook) : null;
		$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		while ($cur_forum_perm = $forum_db->fetch_assoc($result))
		{
			...
			($hook = ForumFunction::get_hook('agr_add_end_qr_add_group_forum_perms')) ? eval($hook) : null;
			$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		}
	}
	else
	{
		...
		($hook = ForumFunction::get_hook('agr_edit_end_edit_group')) ? eval($hook) : null;
		...
		if ($moderator == '1' && $forum_config['o_default_user_group'] == $group_id)
			ForumFunction::message($lang_admin_groups['Moderator default group']);
		...
		($hook = ForumFunction::get_hook('agr_edit_end_qr_check_edit_group_title_collision')) ? eval($hook) : null;
		$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		...
		($hook = ForumFunction::get_hook('agr_edit_end_qr_update_group')) ? eval($hook) : null;
		$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
	...
	Cache::generate_quickjump_cache();

	// Add flash message
	$forum_flash->add_info((($_POST['mode'] == 'edit') ? $lang_admin_groups['Group edited'] : $lang_admin_groups['Group added']));

	($hook = ForumFunction::get_hook('agr_add_edit_pre_redirect')) ? eval($hook) : null;

	ForumFunction::redirect(ForumFunction::forum_link($forum_url['admin_groups']), (($_POST['mode'] == 'edit') ? $lang_admin_groups['Group edited'] : $lang_admin_groups['Group added']));
}
...
else if (isset($_POST['set_default_group']))
{
	...
	($hook = ForumFunction::get_hook('agr_set_default_group_form_submitted')) ? eval($hook) : null;
	...
	($hook = ForumFunction::get_hook('agr_set_default_group_qr_get_group_moderation_status')) ? eval($hook) : null;
	$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
	...
	($hook = ForumFunction::get_hook('agr_set_default_group_qr_set_default_group')) ? eval($hook) : null;
	$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
	...
	($hook = ForumFunction::get_hook('agr_set_default_group_pre_redirect')) ? eval($hook) : null;

	ForumFunction::redirect(ForumFunction::forum_link($forum_url['admin_groups']), $lang_admin_groups['Default group set']);
}
...
else if (isset($_GET['del_group']))
{
	...
	if (isset($_POST['del_group_cancel']))
		ForumFunction::redirect(ForumFunction::forum_link($forum_url['admin_groups']), $lang_admin_common['Cancel redirect']);

	// Make sure we don't remove the default group
	if ($group_id == $forum_config['o_default_user_group'])
		ForumFunction::message($lang_admin_groups['Cannot remove default group']);

	($hook = ForumFunction::get_hook('agr_del_group_selected')) ? eval($hook) : null;
	...
	($hook = ForumFunction::get_hook('agr_del_group_qr_get_group_member_count')) ? eval($hook) : null;
	$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
	...
	{
		($hook = ForumFunction::get_hook('agr_del_group_form_submitted')) ? eval($hook) : null;
		...
		if (isset($_POST['del_group']))	// Move users
		{
			...
			($hook = ForumFunction::get_hook('agr_del_group_qr_move_users')) ? eval($hook) : null;
			$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		}
		...
		($hook = ForumFunction::get_hook('agr_del_group_qr_delete_group')) ? eval($hook) : null;
		$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		...
		($hook = ForumFunction::get_hook('agr_del_group_qr_delete_group_forum_perms')) ? eval($hook) : null;
		$forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
		...
		($hook = ForumFunction::get_hook('agr_del_group_pre_redirect')) ? eval($hook) : null;

		ForumFunction::redirect(ForumFunction::forum_link($forum_url['admin_groups']), $lang_admin_groups['Group removed']);
	}
	...
	($hook = ForumFunction::get_hook('agr_del_group_pre_header_load')) ? eval($hook) : null;
	...
	($hook = ForumFunction::get_hook('agr_del_group_output_start')) ? eval($hook) : null;

?>
	<div class="main-subhead">
		<h2 class="hn"><span><?php printf($lang_admin_groups['Remove group head'], ForumFunction::forum_htmlencode($group_info['title']), $group_info['num_members']) ?></span></h2>
	</div>
	<div class="main-content main-frm">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo ForumFunction::forum_link($forum_url['admin_groups']) ?>?del_group=<?php echo $group_id ?>">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo ForumFunction::generate_form_token(ForumFunction::forum_link($forum_url['admin_groups']).'?del_group='.$group_id) ?>" />
			</div>
<?php ($hook = ForumFunction::get_hook('agr_del_group_pre_del_fieldset')) ? eval($hook) : null; ?>
...
<?php ($hook = ForumFunction::get_hook('agr_del_group_pre_move_to_group')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
...
<?php
	...
	($hook = ForumFunction::get_hook('agr_del_group_qr_get_groups')) ? eval($hook) : null;
	$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
...
<?php ($hook = ForumFunction::get_hook('agr_del_group_pre_del_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = ForumFunction::get_hook('agr_del_group_del_fieldset_end')) ? eval($hook) : null; ?>
			<div class="frm-buttons">
...
<?php
	...
	($hook = ForumFunction::get_hook('agr_del_group_end')) ? eval($hook) : null;
...
($hook = ForumFunction::get_hook('agr_pre_header_load')) ? eval($hook) : null;
...
($hook = ForumFunction::get_hook('agr_main_output_start')) ? eval($hook) : null;
...
?>
	...
	<div class="main-content main-frm">
		<form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo ForumFunction::forum_link($forum_url['admin_groups']) ?>?action=foo">
			<div class="hidden">
				<input type="hidden" name="csrf_token" value="<?php echo ForumFunction::generate_form_token(ForumFunction::forum_link($forum_url['admin_groups']).'?action=foo') ?>" />
			</div>
<?php ($hook = ForumFunction::get_hook('agr_pre_add_group_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Add group legend'] ?></span></legend>
<?php ($hook = ForumFunction::get_hook('agr_pre_add_base_group')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
...
($hook = ForumFunction::get_hook('agr_qr_get_allowed_base_groups')) ? eval($hook) : null;
$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
while ($cur_group = $forum_db->fetch_assoc($result))
	echo "\t\t\t\t\t\t\t".'<option value="'.$cur_group['g_id'].($cur_group['g_id'] == $forum_config['o_default_user_group'] ? '" selected="selected">' : '">').ForumFunction::forum_htmlencode($cur_group['g_title']).'</option>'."\n";

?>
						</select></span>
					</div>
				</div>
<?php ($hook = ForumFunction::get_hook('agr_pre_add_group_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = ForumFunction::get_hook('agr_add_group_fieldset_end')) ? eval($hook) : null; ?>
			<div class="frm-buttons">
...
<?php ($hook = ForumFunction::get_hook('agr_pre_default_group_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><span><?php echo $lang_admin_groups['Default group legend'] ?></span></legend>
<?php ($hook = ForumFunction::get_hook('agr_pre_default_group')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
...
($hook = ForumFunction::get_hook('agr_qr_get_groups')) ? eval($hook) : null;
$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
while ($cur_group = $forum_db->fetch_assoc($result))
{
...
<?php ($hook = ForumFunction::get_hook('agr_pre_default_group_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = ForumFunction::get_hook('agr_default_group_fieldset_end')) ? eval($hook) : null; ?>
			<div class="frm-buttons">
...
($hook = ForumFunction::get_hook('agr_qr_get_group_list')) ? eval($hook) : null;
$result = $forum_db->query_build($query) or ForumFunction::error(__FILE__, __LINE__);
$forum_page['item_num'] = 0;
while ($cur_group = $forum_db->fetch_assoc($result))
{
	$forum_page['group_options'] = array(
		'edit' => '<span class="first-item"><a href="'.ForumFunction::forum_link($forum_url['admin_groups']).'?edit_group='.$cur_group['g_id'].'">'.$lang_admin_groups['Edit group'].'</a></span>'
	);

	if ($cur_group['g_id'] > FORUM_GUEST)
	{
		if ($cur_group['g_id'] != $forum_config['o_default_user_group'])
			$forum_page['group_options']['remove'] = '<span'.((empty($forum_page['group_options'])) ? ' class="first-item"' : '').'><a href="'.ForumFunction::forum_link($forum_url['admin_groups']).'?del_group='.$cur_group['g_id'].'">'.$lang_admin_groups['Remove group'].'</a></span>';
		else
	...
	($hook = ForumFunction::get_hook('agr_edit_group_row_pre_output')) ? eval($hook) : null;

?>
			<div class="ct-set set<?php echo ++$forum_page['item_count'] ?>">
				<div class="ct-box">
					<h3 class="ct-legend hn"><span><?php echo ForumFunction::forum_htmlencode($cur_group['g_title']) ?> <?php if ($cur_group['g_id'] == $forum_config['o_default_user_group']) echo $lang_admin_groups['default']; ?></span></h3>
					<p class="options"><?php echo implode(' ', $forum_page['group_options']) ?></p>
				</div>
			</div>
<?php

	($hook = ForumFunction::get_hook('agr_edit_group_row_post_output')) ? eval($hook) : null;
}
...
($hook = ForumFunction::get_hook('agr_end')) ? eval($hook) : null;
