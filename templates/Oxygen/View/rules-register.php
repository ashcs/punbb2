...
<?	($hook = \Punbb\ForumFunction::get_hook('rg_rules_output_start')) ? eval($hook) : null;
...
?>
	...
	<div class="main-content main-frm">
		...
		<form class="frm-form" method="get" accept-charset="utf-8" action="<?php echo \Punbb\ForumFunction::forum_link($forum_url['register']) ?>">
<?php ($hook = \Punbb\ForumFunction::get_hook('rg_rules_pre_group')) ? eval($hook) : null; ?>
			<div class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
<?php ($hook = \Punbb\ForumFunction::get_hook('rg_rules_pre_agree_checkbox')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('rg_rules_pre_group_end')) ? eval($hook) : null; ?>
			</div>
<?php ($hook = \Punbb\ForumFunction::get_hook('rg_rules_group_end')) ? eval($hook) : null; ?>
...
<?php 	($hook = \Punbb\ForumFunction::get_hook('rg_rules_end')) ? eval($hook) : null;  ?>
