...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_info')) ? eval($hook) : null; ?>
		<div class="profile ct-group data-group vcard">
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_ident_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_contact_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_activity_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_sig_info')) ? eval($hook) : null; ?>
...
<?php endif; ?>
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_pre_user_private_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_change_details_about_user_info_end')) ? eval($hook) : null; ?>
	</div>
<?php $this->stop() ?>	
