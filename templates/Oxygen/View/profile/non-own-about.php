...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_output_start')) ? eval($hook) : null; ?>
	<div class="main-head">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_pre_user_info')) ? eval($hook) : null; ?>
		<div class="profile ct-group data-group vcard">
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_pre_user_ident_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_pre_user_contact_info')) ? eval($hook) : null; ?>
...
<?php endif; ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_pre_user_activity_info')) ? eval($hook) : null; ?>
...
<?php endif; ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_pre_user_sig_info')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_user_info_end')) ? eval($hook) : null; ?>
	</div>
<?php ($hook = \Punbb\ForumFunction::get_hook('pf_view_details_end')) ? eval($hook) : null; ?>
