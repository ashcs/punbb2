...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_output_start')) ? eval($hook) : null; ?>
	<div class="main-head">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_pre_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><strong><?php echo $lang_misc['Merge topics'] ?></strong></legend>
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_pre_redirect_checkbox')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_pre_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_fieldset_end')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_merge_topics_end')) ? eval($hook) : null; ?>