...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_output_start')) ? eval($hook) : null; ?>
	<div class="main-head">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_pre_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><strong><?php echo $lang_misc['Split posts'] ?></strong></legend>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_pre_subject')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_pre_confirm_checkbox')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_pre_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_fieldset_end')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_confirm_split_posts_end')) ? eval($hook) : null; ?>
