...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_output_start')) ? eval($hook) : null; ?>
	<div class="main-head">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_pre_fieldset')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_pre_confirm_checkbox')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_pre_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_fieldset_end')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('mr_delete_topics_end')) ? eval($hook) : null; ?>