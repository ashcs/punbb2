...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_main_output_start')) ? eval($hook) : null; ?>
	<div class="main-head">
<?php
...
<?php endif; ?>
		<form id="afocus" class="frm-form" method="get" accept-charset="utf-8" action="<?php echo \Punbb\ForumFunction::forum_link($forum_url['search']) ?>">
			<div class="hidden">
				<input type="hidden" name="action" value="search" />
			</div>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_criteria_fieldset')) ? eval($hook) : null; ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><strong><?php echo $lang_search['Search legend'] ?></strong></legend>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_keywords')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_author')) ? eval($hook) : null; ?>
<?php if ($advanced_search): ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box text">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_search_in')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_forum_fieldset')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_forum_checklist')) ? eval($hook) : null; ?>
					<div class="mf-box">
						<div class="checklist">
<?php
...
if (!empty($forums))
{
	...
	{
		($hook = \Punbb\ForumFunction::get_hook('se_forum_loop_start')) ? eval($hook) : null;
		...
		if ($cur_forum['cid'] != $cur_category)	// A new category since last iteration?
		{
			...
			echo "\t\t\t\t\t\t\t".'<fieldset>'."\n\t\t\t\t\t\t\t\t".'<legend><span>'.\Punbb\ForumFunction::forum_htmlencode($cur_forum['cat_name']).':</span></legend>'."\n";
			$cur_category = $cur_forum['cid'];
		}

		echo "\t\t\t\t\t\t\t\t".'<div class="checklist-item"><span class="fld-input"><input type="checkbox" id="fld'.(++$forum_page['fld_count']).'" name="forum[]" value="'.$cur_forum['fid'].'" /></span> <label for="fld'.$forum_page['fld_count'].'">'.\Punbb\ForumFunction::forum_htmlencode($cur_forum['forum_name']).'</label></div>'."\n";
		
		($hook = \Punbb\ForumFunction::get_hook('se_forum_loop_end')) ? eval($hook) : null;
	}
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_forum_fieldset_end')) ? eval($hook) : null; ?>
				</fieldset>
<?php endif; ?>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_forum_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_criteria_fieldset_end')) ? eval($hook) : null; ?>
<?php $forum_page['item_count'] = 0; ?>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_results_fieldset')) ? eval($hook) : null; ?>
<?php if ($advanced_search): ?>
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<legend class="group-legend"><strong><?php echo $lang_search['Results legend'] ?></strong></legend>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_sort_by')) ? eval($hook) : null; ?>
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_sort_order_fieldset')) ? eval($hook) : null; ?>
				<fieldset class="mf-set set<?php echo ++$forum_page['item_count'] ?>">
					<legend><span><?php echo $lang_search['Sort order'] ?></span></legend>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_sort_order')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_sort_order_fieldset_end')) ? eval($hook) : null; ?>
				</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_display_choices_fieldset')) ? eval($hook) : null; ?>
				<fieldset class="mf-set set<?php echo ++$forum_page['item_count'] ?>">
					<legend><span><?php echo $lang_search['Display results'] ?></span></legend>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_display_choices')) ? eval($hook) : null; ?>
					<div class="mf-box mf-yesno">
						<div class="mf-item">
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_new_display_choices')) ? eval($hook) : null; ?>
					</div>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_display_choices_fieldset_end')) ? eval($hook) : null; ?>
				</fieldset>
<?php ($hook = \Punbb\ForumFunction::get_hook('se_pre_results_fieldset_end')) ? eval($hook) : null; ?>
			</fieldset>
<?php endif; ($hook = \Punbb\ForumFunction::get_hook('se_results_fieldset_end')) ? eval($hook) : null; ?>
...
<?php ($hook = \Punbb\ForumFunction::get_hook('se_end')) ? eval($hook) : null; ?>
